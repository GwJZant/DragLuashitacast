...
local sets = {
    Default_Priority = {
        ...
        Ear2 = {'Brutal Earring', 'Dodge Earring'}, --AGI +3
...
profile.OnLoad = function()
    ...
    skillingVariantTable = {'None', 'Field', 'Fishing'};
...
profile.LateInitialize = function()
    ...
    if timestamp >= Settings.LateInitialized.TimeToUse then
        ...
        -- Set this to your default THF macro book
...
profile.HandleDefault = function()
    ...
    -- Equip Cotehardie for Auto-Refresh when MP < 41 and a mage subjob
